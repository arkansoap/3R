...
For the practice of econometrics, i.e. to design (at least some...) diagrammatic representations of models, methods and diagrams that can facilitate the understanding and reading of results.
...
<!--chapter:end:02-Correlation.Rmd-->
...
<!--chapter:end:03-covariane_correlation_vizualsitaion.Rmd-->
...
<!--chapter:end:04-Reg_lin.Rmd-->

# Vizualisation of regression and correlation beetween variable
...
**Another example of venn diagram: Relating species richness to the structure of continuous landscapes**
...
\begin{figure}[H]
  \begin{tikzpicture} [scale=0.9]
    ...
    \only{\tkzMarkAngle[size=1, draw=black,fill=blue!20,mark=|](t,tt,ttt)]}
...
\hspace{3.5ex}
\begin{minipage}{0.35\textwidth}
  And here we decide to represent $V(X+Y)$ like a square in the middle. And du to this last equation, $V(X+Y)$ is area of sum of $4$ rectangles area : $V(X) + V(Y) - 2\sigma_x \sigma_y$
\end{minipage}
...
\hspace{3.5ex}
\begin{minipage}{0.35\textwidth}
  And here we decide to represent $V(X+Y)$ like a pivotate square in the middle. And du to this last equation, $V(X+Y)$ is area of sum of $2$ rectangles area : $V(X) + V(Y)$
\end{minipage}
...
<!--chapter:end:06-liste_packageR.Rmd-->
...
<!--chapter:end:07-liste_packageR.Rmd-->
